...
class MySQLdb {
  ...
  async updateEinteilung(roleId, name, date, type, start, ende) {
    var sql =
      ...
      "), start = " +
      this.mysql.escape(start) +
      ", ende = " +
      this.mysql.escape(ende) +
      " WHERE name = " +
  ...
  async deleteRole(role, type) {
    if (type == "f") {
      var sql1 =
        "UPDATE table SET role_id = 1 WHERE role_id = (SELECT role_id from table where type = " +
        this.mysql.escape(type) +
        " and role like " +
        this.mysql.escape(role) +
        ")";
      await new Promise((resolve, reject) => {
        ...
        console.log("could not update F Role! ");
      });
    } else if (type == "s") {
      var sql1 =
        "UPDATE table SET role_id = 2 WHERE role_id = (SELECT role_id from table where type = " +
        this.mysql.escape(type) +
        " and role like " +
        this.mysql.escape(role) +
        ")";
      await new Promise((resolve, reject) => {
        ...
        console.log("could not update S Role! ");
      });
    } else if (type == "n") {
      var sql1 =
        "UPDATE table SET role_id = 3 WHERE role_id = (SELECT role_id from table where type = " +
        this.mysql.escape(type) +
        " and role like " +
        this.mysql.escape(role) +
        ")";
      await new Promise((resolve, reject) => {
        ...
        console.log("could not update N Role! ");
      });
    }
    var sql2 =
      "Delete FROM table WHERE role = " +
      this.mysql.escape(role) +
      " AND type = " +
      this.mysql.escape(type);
    await new Promise((resolve, reject) => {
  ...
  addEinteilung(roleId, name, date, type, state, start, end) {
    var sql =
      "INSERT INTO table (name, role_id, date, comment, break, start, ende) VALUES (" +
      this.mysql.escape(name) +
  ...
  var sql =
    "SELECT table.name, table.name AS 'ok', table.role FROM table LEFT JOIN table ON table.name_id = table.id RIGHT JOIN table ON table.ok = table.group_id LEFT JOIN table ON table.wish = table.role_id WHERE table.ok != 0;";
  ...
  var sql =
    "SELECT table.name, table.name AS 'no', table.role FROM table LEFT JOIN table ON table.name_id = table.id RIGHT JOIN table ON table.no = table.group_id LEFT JOIN table ON table.wish = table.role_id WHERE table.no != 0;";
