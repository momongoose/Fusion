const db = require("../database/communication4anal");
let mySQl = new db.MySQLdb();

async function insertRole(app){
    app.post("/einteilungAnalytik/role", async (req, res) => {
...
async function getRoles(app){
    app.get("/einteilungAnalytik/roles", async (req, res) => {
...
async function deleteRole(app){
    app.post("/einteilungAnalytik/remrole", async (req, res) => {
        var role = req.body.role
...
async function insertEinteilungF(app){
    app.post("/einteilungAnalytik/einF", async (req, res) => {
...
async function insertMitarbeiter(app){
    app.post("/einteilungAnalytik/addMA", async (req, res) => {
        var ma = req.body.ma
...
async function insertEinteilungS(app){
    app.post("/einteilungAnalytik/einS", async (req, res) => {
        var ein = req.body.ein
        var date = new Date(req.body.date)
        date.setDate(date.getDate() + 2);
        date = date.toISOString()
...
async function insertEinteilungN(app){
    app.post("/einteilungAnalytik/einN", async (req, res) => {
        var ein = req.body.ein
        var date = new Date(req.body.date)
        date.setDate(date.getDate() + 2);
        date = date.toISOString()
...
async function updateBreak(app){
    app.post("/einteilungAnalytik/upBreak", async (req, res) => {
        var ma = req.body.ma
        var date = new Date(req.body.date)
        date.setDate(date.getDate() + 2)
...
async function rename(app){
    app.post("/einteilungAnalytik/ren", async (req, res) => {
...
async function updatePos(app){
    app.post("/einteilungAnalytik/upPos", async (req, res) => {
...
async function remEin(app){
    app.post("/einteilungAnalytik/remEin", async (req, res) => {
...
async function getEinteilung(app) {
    app.post("/einteilungAnalytik/teilung", async (req, res) => {
        var date = new Date(req.body.date)
        date.setDate(date.getDate() + 2)
        date = formatDate(date)
        var esist = false
...
async function getStats(app){
    app.get("/einteilungAnalytik/getStats", async (req, res) => {
