...
@Component({
  selector: 'app-display-anal',
  templateUrl: './display-anal.component.html',
  styleUrls: ['./display-anal.component.scss'],
})
export class DisplayAnalComponent implements OnInit {
  constructor(
    private router: Router,
    private app: AppComponent,
    private ein: EinteilungAnalService
  ) {
