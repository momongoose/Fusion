...
const URL = 'http://localhost:8080/einteilungAnalytik/';
...
export class EinteilungAnalytikService {
  ...
  updateWish(person:any, wish:any, pos:any): Observable<any> {
    return this.http.post(URL + "upWish", {person, wish, pos}, httpOptions);
  }
  remWish(person:any, wish:any, pos:any): Observable<any> {
    return this.http.post(URL + "remWish", {person, wish, pos}, httpOptions);
  }
  getWish(): Observable<any> {
    return this.http.get(URL + "getWish", httpOptions);
  }
}
