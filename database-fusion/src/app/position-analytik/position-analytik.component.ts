...
@Component({
  selector: 'app-position-analytik',
  templateUrl: './position-analytik.component.html',
  styleUrls: ['./position-analytik.component.css']
})
export class PositionAnalytikComponent implements OnInit {

  constructor(public app : AppComponent, private ein : EinteilungAnalytikService, private router : Router) {
