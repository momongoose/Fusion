...
@Component({
  selector: 'app-admin-n-anal',
  templateUrl: './admin-n-anal.component.html',
  styleUrls: ['./admin-n-anal.component.css']
})
export class AdminNAnalComponent implements OnInit {
