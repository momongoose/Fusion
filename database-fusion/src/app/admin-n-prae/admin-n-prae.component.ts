...
@Component({
  selector: 'app-admin-n-prae',
  templateUrl: './admin-n-prae.component.html',
  styleUrls: ['./admin-n-prae.component.css']
})
export class AdminNPraeComponent implements OnInit {
