...
@Component({
  selector: 'app-admin-s-anal',
  templateUrl: './admin-s-anal.component.html',
  styleUrls: ['./admin-s-anal.component.css']
})
export class AdminSAnalComponent implements OnInit {
