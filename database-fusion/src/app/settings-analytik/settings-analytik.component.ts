...
@Component({
  selector: 'app-settings-analytik',
  templateUrl: './settings-analytik.component.html',
  styleUrls: ['./settings-analytik.component.css']
})
export class SettingsAnalytikComponent implements OnInit {

  constructor(private ein : EinteilungService, public app:AppComponent, private einAnal : EinteilungAnalytikService) { }
