...
@Component({
  selector: 'app-admin-f-analytik',
  templateUrl: './admin-f-analytik.component.html',
  styleUrls: ['./admin-f-analytik.component.css']
})
export class AdminFAnalytikComponent implements OnInit {
