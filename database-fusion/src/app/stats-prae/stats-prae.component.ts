...
@Component({
  selector: 'app-stats-prae',
  templateUrl: './stats-prae.component.html',
  styleUrls: ['./stats-prae.component.css']
})
export class StatsPraeComponent implements OnInit {
